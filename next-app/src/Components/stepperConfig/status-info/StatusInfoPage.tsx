...
const validStatuses = ["draft", "under_review", "inactive", "rejected"] as const
    ...
    switch (userStatus) {
      case "under_review":
        return {
          ...
          description:
            "Tu cuenta se encuentra actualmente bajo revisión. Te notificaremos por correo una vez esté aprobada o rechazada.",
