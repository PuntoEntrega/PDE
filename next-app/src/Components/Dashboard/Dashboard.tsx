        ...
        <Card className="bg-white shadow-lg rounded-2xl p-8 mb-8 border-0 overflow-hidden">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex-1 text-center md:text-left mb-6 md:mb-0">
              <div className="mb-6">
                <Image src="/logo.png" alt="Punto Entrega" width={180} height={54} className="h-auto mx-auto md:mx-0" />
              </div>
              <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
                ¡Te damos la bienvenida a nuestro Sistema PdE!
              </h1>
              <p className="text-lg text-blue-700 leading-relaxed">
                En nuestro sistema podrás gestionar la entrega y recepción de paquetes directamente desde tu computadora
                o sistema móvil
              </p>
            </div>
